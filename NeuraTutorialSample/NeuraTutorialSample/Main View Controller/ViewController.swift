...
class ViewController: UIViewController {
    ...
    func updateSymbolState() {
        let isConnected = Neura.isAuthenticated
    ...
    func updateAuthenticationButtonState() {
        let authState = Neura.authenticationState
        var title = ""
        switch authState {
    ...
    func updateAuthenticationLabelState() {
        ...
        case .authenticated, .authenticatedAnonymously:
            ...
            if let neuraUserId = Neura.userId {
    ...
    func logoutFromNeura(){
        guard Neura.isAuthenticated else { return }
        self.showBlockingProgress()
    ...
    func setupUI() {
        ...
        let sdkText = "SDK Version: \(Neura.versionOfSDKVerbose)"
